...
const EN_TEXT = {
  ...
  copyLink: "Copy Link",
  uploadTargetPackage: "Upload target package (.tar/.tgz)",
  uploadTargetHelper:
    "Download the target from packages2.fhir.org, then upload it here to start the import.",
  uploadTargetHint: "Drag & drop the target .tar/.tgz file here",
  uploadTargetOrExplorer: "Upload target package (.tar/.tgz) or FHIR Explorer project (.json/.zip)",
  uploadTargetOrExplorerHelper: "The package must contain package/package.json",
  uploadTargetOrExplorerHint: "Drag & drop .tar/.tgz, .json, or .zip files here",
  ...
  openLink: "Open Link",
  uploadPackageOrExplorer: "Upload package (.tar/.tgz) or FHIR Explorer project (.json/.zip)",
  uploadPackageOrExplorerHelper:
    "Upload target or dependency packages. The importer will detect matches.",
  uploadPackageOrExplorerHint: "Drag & drop .tar/.tgz, .json, or .zip files here",
...
const LOCALE_TEXT = {
  de: {
    ...
    uploadTargetPackage: "Zielpaket hochladen (.tar/.tgz)",
    uploadTargetHelper:
      "Lade das Ziel von packages2.fhir.org herunter und lade es hier hoch, um den Import zu starten.",
    uploadTargetHint: "Ziehe die Ziel-.tar/.tgz-Datei hier hinein",
    uploadTargetOrExplorer: "Zielpaket (.tar/.tgz) oder FHIR-Explorer-Projekt (.json/.zip) hochladen",
    uploadTargetOrExplorerHelper: "Das Paket muss package/package.json enthalten",
    uploadTargetOrExplorerHint: "Ziehe .tar/.tgz-, .json- oder .zip-Dateien hier hinein",
    packageId: "Paket-ID",
    version: "Version",
    ...
    uploadPackageOrExplorer: "Paket (.tar/.tgz) oder FHIR-Explorer-Projekt (.json/.zip) hochladen",
    uploadPackageOrExplorerHelper:
      "Lade Ziel- oder Abhängigkeitspakete hoch. Der Importer erkennt passende Pakete automatisch.",
    uploadPackageOrExplorerHint: "Ziehe .tar/.tgz-, .json- oder .zip-Dateien hier hinein",
  ...
  fr: {
    ...
    uploadTargetPackage: "Televerser le paquet cible (.tar/.tgz)",
    uploadTargetHelper:
      "Telechargez la cible depuis packages2.fhir.org, puis televersez-la ici pour demarrer l'import.",
    uploadTargetHint: "Glisser-deposer le fichier .tar/.tgz cible ici",
    uploadTargetOrExplorer: "Televerser le paquet cible (.tar/.tgz) ou un projet FHIR Explorer (.json/.zip)",
    uploadTargetOrExplorerHelper: "Le paquet doit contenir package/package.json",
    uploadTargetOrExplorerHint: "Glisser-deposer des fichiers .tar/.tgz, .json ou .zip ici",
    ...
    uploadPackageOrExplorer: "Televerser un paquet (.tar/.tgz) ou un projet FHIR Explorer (.json/.zip)",
    uploadPackageOrExplorerHelper:
      "Televersez des paquets cibles ou de dependance. L'importeur detectera les correspondances.",
    uploadPackageOrExplorerHint: "Glisser-deposer des fichiers .tar/.tgz, .json ou .zip ici",
  ...
  es: {
    ...
    uploadTargetPackage: "Subir paquete objetivo (.tar/.tgz)",
    uploadTargetHelper:
      "Descarga el objetivo desde packages2.fhir.org y subelo aqui para iniciar la importacion.",
    uploadTargetHint: "Arrastra y suelta el archivo .tar/.tgz objetivo aqui",
    uploadTargetOrExplorer: "Subir paquete objetivo (.tar/.tgz) o proyecto FHIR Explorer (.json/.zip)",
    uploadTargetOrExplorerHelper: "El paquete debe contener package/package.json",
    uploadTargetOrExplorerHint: "Arrastra y suelta archivos .tar/.tgz, .json o .zip aqui",
    ...
    uploadPackageOrExplorer: "Subir paquete (.tar/.tgz) o proyecto FHIR Explorer (.json/.zip)",
    uploadPackageOrExplorerHelper:
      "Sube paquetes objetivo o de dependencia. El importador detectara coincidencias.",
    uploadPackageOrExplorerHint: "Arrastra y suelta archivos .tar/.tgz, .json o .zip aqui",
  ...
  it: {
    ...
    uploadTargetPackage: "Carica pacchetto target (.tar/.tgz)",
    uploadTargetHelper:
      "Scarica il target da packages2.fhir.org, poi caricalo qui per avviare l'importazione.",
    uploadTargetHint: "Trascina qui il file .tar/.tgz target",
    uploadTargetOrExplorer: "Carica pacchetto target (.tar/.tgz) o progetto FHIR Explorer (.json/.zip)",
    uploadTargetOrExplorerHelper: "Il pacchetto deve contenere package/package.json",
    uploadTargetOrExplorerHint: "Trascina qui file .tar/.tgz, .json o .zip",
    ...
    openLink: "Apri link",
    uploadPackageOrExplorer: "Carica pacchetto (.tar/.tgz) o progetto FHIR Explorer (.json/.zip)",
    uploadPackageOrExplorerHelper:
      "Carica pacchetti target o di dipendenza. L'importatore rilevera le corrispondenze.",
    uploadPackageOrExplorerHint: "Trascina qui file .tar/.tgz, .json o .zip",
