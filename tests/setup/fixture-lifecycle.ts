...
const REQUIRED_RELATIVE_PATHS = [
  ...
  `${FIXTURE_PACKAGE_DIR}/StructureDefinition-Patient.json`,
  `${FIXTURE_PACKAGE_DIR}/StructureDefinition-PatientProfile.json`,
  `${FIXTURE_PACKAGE_DIR}/StructureDefinition-Organization.json`,
  `${FIXTURE_PACKAGE_DIR}/StructureDefinition-Survey.json`,
  `${FIXTURE_PACKAGE_DIR}/StructureDefinition-HumanName.json`,
  `${FIXTURE_PACKAGE_DIR}/StructureDefinition-Period.json`,
  `${FIXTURE_PACKAGE_DIR}/StructureDefinition-Coding.json`,
  `${FIXTURE_PACKAGE_DIR}/StructureDefinition-CodeableConcept.json`,
  `${FIXTURE_PACKAGE_DIR}/StructureDefinition-Identifier.json`,
  `${FIXTURE_PACKAGE_DIR}/StructureDefinition-Reference.json`,
  `${FIXTURE_PACKAGE_DIR}/StructureDefinition-Extension.json`,
  `${FIXTURE_PACKAGE_DIR}/StructureDefinition-birth-place.json`,
  `${FIXTURE_PACKAGE_DIR}/StructureDefinition-contact-preference.json`,
